 ...
 */
"use strict";var safeToString=_dereq_("safe-to-string-x"),isPrimitive=_dereq_("is-primitive");module.exports=function assertIsObject(value){if(isPrimitive(value))throw new TypeError(safeToString(value)+" is not an object");return value}},{"is-primitive":18,"safe-to-string-x":34}],4:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toPropertyKey=_dereq_("to-property-key-x"),hop=Object.prototype.hasOwnProperty;module.exports=function hasOwnProperty(object,property){return hop.call(toObject(object),toPropertyKey(property))}},{"to-object-x":39,"to-property-key-x":41}],7:[function(_dereq_,module,exports){/**
 ...
 * @module is-falsey-x
 */
"use strict";module.exports=function isFalsey(value){return!1===Boolean(value)}},{}],12:[function(_dereq_,module,exports){/**
 ...
 * @module is-finite-x
 */
"use strict";var numberIsNaN=_dereq_("is-nan-x");module.exports=function isFinite(number){return"number"==typeof number&&!1===numberIsNaN(number)&&number!==1/0&&number!==-1/0}},{"is-nan-x":15}],13:[function(_dereq_,module,exports){/**
 ...
 * @module is-nil-x
 */
"use strict";var isUndefined=_dereq_("validate.io-undefined"),isNull=_dereq_("lodash.isnull");module.exports=function isNil(value){return isNull(value)||isUndefined(value)}},{"lodash.isnull":22,"validate.io-undefined":47}],17:[function(_dereq_,module,exports){/**
 ...
 * @module math-sign-x
 */
"use strict";var toNumber=_dereq_("to-number-x"),numberIsNaN=_dereq_("is-nan-x");module.exports=function sign(x){var n=toNumber(x);return 0===n||numberIsNaN(n)?n:n>0?1:-1}},{"is-nan-x":15,"to-number-x":38}],25:[function(_dereq_,module,exports){"use strict";module.exports=9007199254740991},{}],26:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var trim=_dereq_("trim-x"),reNormalize=new RegExp("["+_dereq_("white-space-x").string+"]+","g");module.exports=function normalizeSpace(string){return trim(string).replace(reNormalize," ")}},{"trim-x":46,"white-space-x":48}],27:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var definePropertyFallback,defineGetter,defineSetter,lookupGetter,lookupSetter,owns=_dereq_("has-own-property-x"),toPropertyKey=_dereq_("to-property-key-x"),isFalsey=_dereq_("is-falsey-x"),attempt=_dereq_("attempt-x"),nativeDefProp="function"==typeof Object.defineProperty&&Object.defineProperty,prototypeOfObject=Object.prototype,supportsAccessors=owns(prototypeOfObject,"__defineGetter__");supportsAccessors&&(defineGetter=prototypeOfObject.__defineGetter__,defineSetter=prototypeOfObject.__defineSetter__,lookupGetter=prototypeOfObject.__lookupGetter__,lookupSetter=prototypeOfObject.__lookupSetter__);var $defineProperty,testWorksWith=function _testWorksWith(object,prop){var testResult=attempt(nativeDefProp,object,prop,{});return!1===testResult.threw&&prop in testResult.value};if(nativeDefProp&&("undefined"==typeof document||testWorksWith(document.createElement("div"),"sentinel"))&&(testWorksWith({},"sentinel")?$defineProperty=_dereq_("has-symbol-support-x")&&testWorksWith({},Object(Symbol("")))?nativeDefProp:function defineProperty(object,property,descriptor){return nativeDefProp(object,toPropertyKey(property),descriptor)}:definePropertyFallback=nativeDefProp),isFalsey($defineProperty)||definePropertyFallback){var assertIsObject=_dereq_("assert-is-object-x");$defineProperty=function defineProperty(object,property,descriptor){assertIsObject(object);var propKey=toPropertyKey(property);if(assertIsObject(descriptor),definePropertyFallback){var result=attempt.call(Object,definePropertyFallback,object,propKey,descriptor);if(!1===result.threw)return result.value}if("value"in descriptor)if(supportsAccessors&&(lookupGetter.call(object,propKey)||lookupSetter.call(object,propKey))){var prototype=object.__proto__;object.__proto__=prototypeOfObject,delete object[propKey],object[propKey]=descriptor.value,object.__proto__=prototype}else object[propKey]=descriptor.value;else{var hasGetter="get"in descriptor,hasSetter="set"in descriptor;if(isFalsey(supportsAccessors)&&(hasGetter||hasSetter))throw new TypeError("getters & setters can not be defined on this javascript engine");hasGetter&&defineGetter.call(object,propKey,descriptor.get),hasSetter&&defineSetter.call(object,propKey,descriptor.set)}return object}}module.exports=$defineProperty},{"assert-is-object-x":3,"attempt-x":4,"has-own-property-x":6,"has-symbol-support-x":7,"is-falsey-x":11,"to-property-key-x":41}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var toPropertyKey=_dereq_("to-property-key-x"),toObject=_dereq_("to-object-x"),propIsEnumerable=Object.prototype.propertyIsEnumerable;module.exports=function propertyIsEnumerable(object,property){var prop=toPropertyKey(property);return propIsEnumerable.call(toObject(object),prop)}},{"to-object-x":39,"to-property-key-x":41}],32:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":20}],33:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":16}],34:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function toLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":25,"to-integer-x":36}],38:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x");module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?key:toStr(key)}},{"has-symbol-support-x":7,"to-primitive-x":40,"to-string-x":43}],42:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":22,"validate.io-undefined":47}],43:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":21}],44:[function(_dereq_,module,exports){/**
