...
var is_arguments = __webpack_require__(10);
...
var is_primitive = __webpack_require__(4);
...
var node_modules_is_primitive = __webpack_require__(5);
...
var max_safe_integer = __webpack_require__(7);
...
var has_own_property_x_node_modules_is_primitive = __webpack_require__(6);
...
function dist_to_number_x_esm_toNumber2018(argument) {
  var value = to_primitive_x_dist_to_primitive_x_esm_toPrimitive(argument, to_number_x_dist_to_number_x_esm_castNumber);
...
function clamp(value) {
  ...
  var min = dist_to_number_x_esm_toNumber2018(arguments[1]);
  var max;
  ...
  if (argsLength < 3) {
    ...
    /* eslint-disable-next-line prefer-rest-params */
    max = dist_to_number_x_esm_toNumber2018(arguments[2]);
  }
...
var node_modules_max_safe_integer = __webpack_require__(8);
...
function isIndex(value, length) {
  ...
  var number = dist_to_number_x_esm_toNumber2018(string);

  if (arguments.length > 1) {
    return number < clamp(dist_to_integer_x_esm_toInteger2018(length), node_modules_max_safe_integer_default.a);
  }

  return number < node_modules_max_safe_integer_default.a;
}
